...
// -return by default
// -run when they are called upom (phatArrow()) 
...
// -may consist of more than one line, given they are wrapped in {curly boys}

let name = (firstName, lastName) => {
    return `My name is ${firstName} ${lastName}`
}
console.log(name("Denea", "Ransom"));
...
// -can be more than one line as long as contained by {curly boys}
